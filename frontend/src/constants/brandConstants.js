...
export const BRAND_ALL_LIST_REQUEST = 'BRAND_ALL_LIST_REQUEST'
export const BRAND_ALL_LIST_SUCCESS = 'BRAND_ALL_LIST_SUCCESS'
export const BRAND_ALL_LIST_FAIL = 'BRAND_ALL_LIST_FAIL'
